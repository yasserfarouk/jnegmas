...
public class GreedyFactoryManager implements FactoryManager {
    @Override
    public void init() {
    ...
    @Override
    public void on_negotiation_failure(ArrayList<String> partners, HashMap<String, Object> annotation, MechanismInfo mechanis, MechanismState state) {
    ...
    @Override
    public String respond_to_renegotiation_request(Contract contract, ArrayList<HashMap<String, Breach>> breaches, RenegotiationRequest agenda) {
        return null;
    }
